 ...
 * Originally written by Rochet2 - Copyright (C) 2018-2020 AzerothCore <www.azerothcore.org>, released under GNU AGPL v3 license: http://github.com/azerothcore/azerothcore-wotlk/blob/master/LICENSE-AGPL3
 */
