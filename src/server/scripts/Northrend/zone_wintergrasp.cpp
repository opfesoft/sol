 ...
 * Copyright (C) 2016-2020 AzerothCore <www.azerothcore.org>, released under GNU GPL v2 license, you may redistribute it and/or modify it under version 2 of the License, or (at your option), any later version. This program is free software; you can redistribute it and/or modify
...
enum CreatureIds
{
    ...
    GOSSIP_TEXT_CANNOT_BUILD            = 13786,
};
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (canBuild(creature))
            {
                ...
                SendGossipMenuFor(player, GOSSIP_TEXT_CANNOT_BUILD, creature->GetGUID());
