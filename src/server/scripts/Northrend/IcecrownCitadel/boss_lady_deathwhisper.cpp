 ...
 * Originally written by Pussywizard - Copyright (C) 2016-2020 AzerothCore <www.azerothcore.org>, released under GNU AGPL v3 license: https://github.com/azerothcore/azerothcore-wotlk/blob/master/LICENSE-AGPL3
*/
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_CULTIST_DARK_MARTYRDOM_REVIVE:
                        ...
                        me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_STUNNED | UNIT_FLAG_SUPPRESS_CHAT_EMOTES | UNIT_FLAG_NOT_SELECTABLE);
                    ...
                    case EVENT_SPELL_CULTIST_DARK_MARTYRDOM:
                        ...
                        me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_STUNNED | UNIT_FLAG_SUPPRESS_CHAT_EMOTES | UNIT_FLAG_NOT_SELECTABLE);
                        Reset();
