...
enum SpellAttr5
{
    ...
    SPELL_ATTR5_IGNORE_AREA_EFFECT_PVP_CHECK     = 0x00000040, //  6
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_NOT_RESET_SWING_IF_INSTANT       = 0x02000000, // 25 do not reset swing timer if cast time is instant (e.g. Exorcism, Flash of Light)
