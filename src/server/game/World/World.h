...
enum WorldBoolConfigs
{
    ...
    CONFIG_DURABILITY_LOSS_ENABLE,
    CONFIG_USE_FULL_PRECISION_LINEAR_SPLINES,
...
enum WorldIntConfigs
{
    ...
    CONFIG_START_PLAYER_MONEY_HERO_CLASS,
    ...
    CONFIG_RATE_REPUTATION_GAIN_THRESHOLD,
