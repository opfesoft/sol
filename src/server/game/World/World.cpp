...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_INSTANCE_SHARED_ID]       = sConfigMgr->GetBoolDefault("Instance.SharedNormalHeroicId", true);
    ...
    m_int_configs[CONFIG_GM_FLYING]             = sConfigMgr->GetIntDefault("GM.Flying", 2);
    ...
    m_int_configs[CONFIG_START_GM_LEVEL]        = sConfigMgr->GetIntDefault("GM.StartLevel", 80);
    ...
    m_bool_configs[CONFIG_START_CUSTOM_SPELLS]   = sConfigMgr->GetBoolDefault("PlayerStart.CustomSpells", false);
