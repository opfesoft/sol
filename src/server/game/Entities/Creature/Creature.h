...
enum CreatureFlagsExtra : uint32
{
    ...
    CREATURE_FLAG_EXTRA_UNUSED_10           = 0x00000200,   // TC: CREATURE_FLAG_EXTRA_NO_MOVE_FLAGS_UPDATE (creature won't update movement flags)
    ...
    CREATURE_FLAG_EXTRA_UNUSED_13           = 0x00001000,   // TC: CREATURE_FLAG_EXTRA_NO_SELL_VENDOR (players can't sell items to this vendor)
    ...
    CREATURE_FLAG_EXTRA_UNUSED_31           = 0x40000000,   // TC: Implement CREATURE_FLAG_EXTRA_IMMUNITY_KNOCKBACK (creature is immune to knockback effects)
