...
enum BG_AV_ObjectIds
{
    ...
    BG_AV_FORGE1                        = 161487,
    BG_AV_FORGE2                        = 34571,
    BG_AV_CAULDRON                      = 177396,
    BG_AV_WANTED_ORCS                   = 179437,
    BG_AV_WANTED_DWARVES                = 179438,
};
...
//auras for graveyards (3auras per graveyard neutral, alliance, horde)
    ...
    BG_AV_OBJECT_CAULDRON                    = 321,
    BG_AV_OBJECT_WANTED_ORCS                 = 322,
    BG_AV_OBJECT_WANTED_DWARVES              = 323,
...
enum BG_AV_OBJECTS
{
    ...
    AV_OPLACE_CAULDRON                    = 233,
    AV_OPLACE_WANTED_ORCS                 = 234,
    AV_OPLACE_WANTED_DWARVES              = 235,
...
const float BG_AV_ObjectPos[AV_OPLACE_MAX][4] =
{
    ...
    {-5.98025f, -326.144f, 38.8538f, 0.f},
    {-2.67893f, -306.998f, 33.4165f, 0.f},
    {-60.25f, -309.232f, 50.2408f, -1.46608f},
    {-48.7941f, -266.533f, 47.7916f, 2.44346f},
    {-3.40929f, -306.288f, 33.34f, 0.f},
    {-48.619f, -266.917f, 47.8168f, 0.f},
    {-62.9474f, -286.212f, 66.7288f, 0.f},
    {-5.05132f, -325.323f, 38.8536f, 0.f},
    {-64.2677f, -289.412f, 33.469f, 0.f},
//horde
    {-524.276f, -199.6f, 82.8733f, -1.46608f},
    {-518.196f, -173.085f, 102.43f, 0.f},
    {-500.732f, -145.358f, 88.5337f, 2.44346f},
    {-501.084f, -150.784f, 80.8506f, 0.f},
    {-518.309f, -163.963f, 102.521f, 2.96706f},
    {-517.053f, -200.429f, 80.759f, 0.f},
    {-514.361f, -163.864f, 104.163f, 0.f},
    {-568.04f, -188.707f, 81.55f, 0.f},
    {-501.775f, -151.581f, 81.2027f, 0.f},
    {-509.975f, -191.652f, 83.2978f, 0.f},
...
//snowfall eyecandy
    ...
    // chairs
    {-168.342f, -458.4f, 33.2862f, 5.83813f},
    {-155.405f, -440.24f, 33.2862f, 2.34747f},
    {-153.748f, -438.639f, 33.2862f, 3.39467f},
    {-150.787f, -459.829f, 26.4163f, 0.558504f},
    {-149.057f, -461.089f, 26.4163f, 1.38754f},
    {-145.341f, -444.846f, 26.4163f, 6.23083f},
    {-142.968f, -444.076f, 26.4163f, 4.04917f},
    {25.2482f, -433.104f, 47.6369f, 2.38237f},
    {25.758f, -425.837f, 47.6369f, 4.30224f},
    {27.6786f, -427.69f, 47.6369f, 3.60411f},
    {39.0988f, -425.746f, 44.688f, 5.66359f},
    {41.1672f, -426.866f, 44.6828f, 2.7838f},
    {550.597f, -77.5213f, 44.8257f, 4.23242f},
    {550.678f, -79.8234f, 44.8257f, 3.18527f},
    {555.517f, -101.589f, 44.8257f, 0.392697f},
    {560.834f, -75.4266f, 37.9558f, 0.785397f},
    {561.851f, -73.1481f, 37.9558f, 4.88692f},
    {568.326f, -89.4992f, 37.9558f, 1.39626f},
    {570.419f, -89.0567f, 37.9558f, 2.22529f},
    // bonfires
    {360.915f, -497.099f, 71.3389f, 3.14159f},
    {-743.427f, -398.241f, 76.4266f, 0.872664f},
    // burning embers
    {-1235.57f, -241.478f, 73.4377f, 1.48353f},
    {-1248.85f, -254.06f, 73.4377f, 1.48353f},
    {-1248.15f, -245.599f, 73.4377f, 6.23083f},
    {-1237.21f, -260.168f, 73.4377f, 1.48353f},
    {-1260.37f, -248.767f, 77.9454f, 1.48353f},
    {-1249.32f, -244.907f, 92.3372f, 0.401425f},
    {-1250.09f, -254.604f, 92.3015f, 0.148352f},
    // campfire 1
    {-1286.25f, -184.481f, 71.8334f, 4.23243f},
    {-1280.17f, -220.536f, 72.2686f, 1.62315f},
    // campfire 2
    {-375.017f, -523.71f, 84.0771f, 3.14159f},
    {-413.51f, -521.413f, 84.0771f, 2.05948f},
    {-487.401f, -526.486f, 82.5708f, 5.47161f},
    {-251.556f, -562.061f, 68.1725f, 6.11738f},
    {-353.118f, 37.0955f, 65.8904f, 3.14159f},
    // campfire 3
    {-1070.53f, -617.908f, 51.3249f, 5.83813f},
    // brazier 1
    {-1290.27f, -172.47f, 72.1853f, 3.06302f},
    // brazier 2
    {-1423.16f, -318.436f, 89.1136f, 2.35619f},
    // brazier 3
    {-1099.21f, -266.231f, 57.8849f, 3.99681f},
    {-1082.6f, -266.681f, 57.8575f, 2.40855f},
    // brazier 4
    {-1140.82f, -343.392f, 50.9077f, 3.49939f},
    {-1139.68f, -356.288f, 51.264f, 5.57633f},
    {-1215.59f, -371.946f, 56.5293f, 0.357792f},
    {-1241.25f, -345.115f, 59.6867f, 0.357792f},
    {-1202.81f, -271.599f, 72.5805f, 0.357792f},
    {-1282.21f, -284.083f, 87.256f, 6.2221f},
    {-1256.55f, -280.278f, 73.9473f, 6.2221f},
    // anvil 1
    {360.38f, -527.549f, 71.1205f, 4.23242f},
    {646.207f, -57.2431f, 41.6587f, 6.12611f},
    {-1245.2f, -307.059f, 63.3199f, 3.0796f},
    {-1258.23f, -310.977f, 63.2015f, 0.862903f},
    // anvil 2
    {-172.363f, -452.824f, 33.2796f, 0.628319f},
    {548.682f, -100.846f, 44.8191f, 1.46608f},
    {-171.282f, -456.892f, 33.2796f, 1.63188f},
    {552.429f, -102.764f, 44.8191f, 2.46964f},
    {-172.356f, -453.88f, 33.2796f, 0.322884f},
    {549.472f, -101.547f, 44.8191f, 1.16064f},
    {-171.882f, -454.632f, 33.2796f, 0.759217f},
    {550.347f, -101.698f, 44.8191f, 1.59698f},
    {-171.656f, -455.671f, 33.2796f, 0.0610847f},
    {551.271f, -102.226f, 44.8191f, 0.898843f},
    {-170.699f, -458.41f, 33.2796f, 5.25344f},
    {553.947f, -103.347f, 44.8191f, 6.0912f},
    {-170.14f, -457.609f, 33.2796f, 5.60251f},
    {553.725f, -102.396f, 44.8191f, 0.157079f},
    {-100.071f, -583.512f, 41.7316f, 0.00872424f},
    {-102.733f, -588.775f, 41.7316f, 5.24472f},
    {-100.966f, -586.958f, 41.7316f, 5.76831f},
    {-106.172f, -589.721f, 41.7316f, 4.72112f},
    // forge 1
    {361.097f, -531.693f, 71.1898f, 4.12771f},
    {649.264f, -59.1111f, 41.5476f, 3.59538f},
    // forge 2
    {-105.423f, -584.352f, 42.0149f, 2.36492f},
    // cauldron
    {12.8247f, -120.21f, 41.6669f, 3.14159f},
    // wanted: orcs
    {618.748f, -52.1126f, 42.1122f, 6.21337f},
    // wanted: dwarves
    {-1181.10f, -370.747f, 53.6246f, 2.68781f}
};
