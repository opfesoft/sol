...
enum FactionTemplateFlags
{
    ...
    FACTION_TEMPLATE_FLAG_ASSIST_PLAYERS                     = 0x0800, // Old title: FACTION_TEMPLATE_FLAG_PVP, Old comment: flagged for PvP
    FACTION_TEMPLATE_FLAG_ATTACK_PVP_ACTIVE_PLAYERS          = 0x1000, // Old title: FACTION_TEMPLATE_FLAG_CONTESTED_GUARD, Old comment: faction will attack players that were involved in PvP combats
    FACTION_TEMPLATE_FLAG_HATES_ALL_EXCEPT_FRIENDS           = 0x2000, // Old title: FACTION_TEMPLATE_FLAG_HOSTILE_BY_DEFAULT, Old comment: none
};
