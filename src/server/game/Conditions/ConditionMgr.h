...
{                                                           // value1           value2         value3
    ...
    CONDITION_NEAR_UNIT             = 29,                   // 0|creature entry distance       dead               true if there is a creature of entry in range (entry 0: if a player is in range)
    CONDITION_NEAR_GAMEOBJECT       = 30,                   // gameobject entry distance       state              true if there is a gameobject of entry in range (state 0: all; 1: spawned only; 2: spawned,GO_STATE_ACTIVE; 3: spawned,GO_STATE_READY; 4: spawned,GO_STATE_ACTIVE_ALTERNATIVE)
    ...
    CONDITION_NEAR_CREATURE_GUID       = 155,                // guid             distance       dead               true if there is a creature with the specified GUID in range
    CONDITION_RANGE3_END               = 156                 // placeholder
};
