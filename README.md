...
- Only specific AC commits will be taken over (sometimes modified); a list of skipped AC commits is available here: [Skipped-AC-Commits](https://gitlab.com/opfesoft/sol-docs/-/blob/master/misc/Skipped-AC-Commits.md); Sol aims exclusively at fixing bugs (from a player's point of view), features will only be taken over if they are useful for accomplishing this goal
