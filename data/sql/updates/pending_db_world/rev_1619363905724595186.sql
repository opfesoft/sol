...
DELETE FROM `reference_loot_template` WHERE `Entry` = 526790;
...
DELETE FROM `creature_loot_template` WHERE `Entry` IN (763,2605,2604,14234,14226,2744) AND `Reference` = 526790;
