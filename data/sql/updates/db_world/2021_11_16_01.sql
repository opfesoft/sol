-- DB update 2021_11_16_00 -> 2021_11_16_01
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_11_16_00';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_11_16_00 2021_11_16_01 bit;
...
-- Vmangos
UPDATE `creature_equip_template` SET `ItemID1`=2177 WHERE `CreatureID`=4667 AND `ID`=1;
