-- DB update 2021_10_19_06 -> 2021_10_20_00
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_10_19_06';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_10_19_06 2021_10_20_00 bit;
...
UPDATE `creature_addon` SET `bytes2` = 4097 WHERE `guid` = 32907;
