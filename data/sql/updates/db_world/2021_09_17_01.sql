...
SELECT sql_rev INTO OK FROM version_db_world WHERE sql_rev = '1631538023459456277'; IF OK <> 'FALSE' THEN LEAVE proc; END IF;
--
...
DELETE FROM `smart_scripts` WHERE `entryorguid` = 14275 AND `source_type` = 0 AND `id` = 1;
