-- DB update 2021_09_02_09 -> 2021_09_02_10
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_09_02_09';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_09_02_09 2021_09_02_10 bit;
...
-- deDE
UPDATE `quest_template_locale` SET `CompletedText` = 'Kehrt zu Bashana Runentotem bei der Anhöhe der Ältesten in Donnerfels zurück.' WHERE `ID` = 6561 AND `locale` = 'deDE';
