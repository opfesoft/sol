...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_09_17_01';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_09_17_01 2021_09_17_02 bit;
...
UPDATE `quest_template` SET `QuestCompletionLog` = 'Return to Pilot Bellowfiz at Steelgrill\'s Depot in Dun Morogh.' WHERE `ID` = 317;
-- esES
