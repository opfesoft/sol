...
SELECT sql_rev INTO OK FROM version_db_world WHERE sql_rev = '1626777621665410700'; IF OK <> 'FALSE' THEN LEAVE proc; END IF;
--
...
UPDATE `creature_addon` SET `bytes2` = 1 WHERE `guid` = 27938;
