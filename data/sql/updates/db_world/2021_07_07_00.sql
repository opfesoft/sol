...
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_07_06_02 2021_07_07_00 bit;
...
UPDATE `reference_loot_template` SET `MaxCount` = 1 WHERE `Entry` = 11105 AND `Item` = 13888;
