-- DB update 2021_04_30_05 -> 2021_05_02_00
...
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_04_30_05 2021_05_02_00 bit;
...
DELETE FROM `reference_loot_template` WHERE `Entry` = 526780;
...
DELETE FROM `creature_loot_template` WHERE `Entry` IN (2779,5356,8211,14491,14448,14492,14224) AND `Reference` = 526780;
