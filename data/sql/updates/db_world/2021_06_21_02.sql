...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_06_21_01';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_06_21_01 2021_06_21_02 bit;
...
(37942, 'deDE', 'Arkanist Uovril', 'Rüstmeister für Embleme des Frosts', 18019),
...
(37941, 'deDE', 'Magister Arlan', 'Rüstmeister für Embleme des Frosts', 18019),
...
(35495, 'deDE', 'Magistrix Vesara', 'Rüstmeister für Embleme des Triumphs', 18019),
...
(35494, 'deDE', 'Arkanistin Miluria', 'Rüstmeister für Embleme des Triumphs', 18019),
...
(33964, 'deDE', 'Arkanist Firael', 'Rüstmeister für Embleme der Eroberung', 18019),
...
(33963, 'deDE', 'Magister Sarien', 'Rüstmeister für Embleme der Eroberung', 18019),
...
(31582, 'deDE', 'Magistrix Lambriesse', 'Rüstmeister für Embleme des Heldentums', 18019),
...
(31581, 'deDE', 'Magister Brasael', 'Rüstmeister für Embleme der Ehre', 18019),
...
(31580, 'deDE', 'Arkanistin Ivrenne', 'Rüstmeister für Embleme des Heldentums', 18019),
...
(31579, 'deDE', 'Arkanist Adurin', 'Rüstmeister für Embleme der Ehre', 18019),
