-- DB update 2021_09_13_03 -> 2021_09_15_00
...
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_09_13_03 2021_09_15_00 bit;
...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
  ('debug lfg', 3, 'Syntax: .debug lfg\r\nToggle debug mode for LFG. In debug mode the GM can start a LFG queue with only one player.');
