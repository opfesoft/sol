-- DB update 2021_09_08_01 -> 2021_09_09_00
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_09_08_01';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_09_08_01 2021_09_09_00 bit;
...
(193, 34535, 0, 0.1, 0, 1, 0, 1, 1, NULL);
