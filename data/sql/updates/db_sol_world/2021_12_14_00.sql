-- DB update 2021_12_13_00 -> 2021_12_14_00
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_sol_world' AND COLUMN_NAME = '2021_12_13_00';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_sol_world CHANGE COLUMN 2021_12_13_00 2021_12_14_00 bit;
SELECT sql_rev INTO OK FROM version_db_sol_world WHERE sql_rev = '1639481615123626832'; IF OK <> 'FALSE' THEN LEAVE proc; END IF;
--
-- START UPDATING QUERIES
--

INSERT INTO `version_db_sol_world` (`sql_rev`) VALUES ('1639481615123626832');

UPDATE `waypoint_data` SET `orientation` = 4.93611 WHERE `id` = 2190 AND `point` = 1;
UPDATE `waypoint_data` SET `orientation` = 2.19912 WHERE `id` = 2190 AND `point` = 4;
...
(18870,16,-4588.73,-1222.18,503.382,5.74213,6000,0,5004,100,0),
