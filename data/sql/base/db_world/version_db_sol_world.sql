...
DROP TABLE IF EXISTS `version_db_sol_world`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `version_db_sol_world` (
  `sql_rev` varchar(100) NOT NULL,
  `required_rev` varchar(100) DEFAULT NULL,
  `2020_04_06_00` bit(1) DEFAULT NULL,
  PRIMARY KEY (`sql_rev`),
...
/*!40000 ALTER TABLE `version_db_sol_world` DISABLE KEYS */;
/*!40000 ALTER TABLE `version_db_sol_world` ENABLE KEYS */;
UNLOCK TABLES;
