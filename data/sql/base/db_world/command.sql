...
('face',1,'Syntax: .face [orientation]\r\nFace the selected unit or set the facing to the specified orientation if no unit is selected.'),
...
('morph',1,'Syntax: .morph #displayid\r\nChange your current model id or the model id of the targeted unit to #displayid. If no #displayid is specified take over the model id of the targeted unit.'),
